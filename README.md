# Мой Python проект с MySQL

Проект демонстрирует интеграцию Python с MySQL, обеспечивает простое управление данными и аутентификацию.

## О проекте

Это демонстрационное приложение, показывающее основы работы с реляционной базой данных MySQL средствами Python. Проект реализует CRUD операции, работу с пользователями и миграциями.
